        ...
        for i in 0..<buttons {
            if i == 0 {
                ...
                let attributes: [NSAttributedString.Key: Any] = [
                    .font: font,
                    .foregroundColor: UIColor(red: 0.0/255.0, green: 118.0/255.0, blue: 188.0/255.0, alpha: 1.0),
                ]
                
                let attributedQuote = NSAttributedString(string: "Avbryt", attributes: attributes)
                
                
                alert.addAction(AlertAction(attributedTitle: attributedQuote, rightImage: nil, style: .preferred))
            } else if i == 1 {
                //                alert.addAction(AlertAction(title: "OK", rightImage: UIImage(named: "editImage"),  style: .normal))
                ...
                let attributes: [NSAttributedString.Key: Any] = [
                    .font: font,
                    .foregroundColor: UIColor(red: 64.5/255.0, green: 64.5/255.0, blue: 64.5/255.0, alpha: 1.0),
                    .paragraphStyle: paragraphStyle
                ]
                
                let attributedQuote = NSAttributedString(string: "Döp om din favoritresa", attributes: attributes)
                
                
                
                
                alert.addAction(AlertAction(attributedTitle: attributedQuote, rightImage: UIImage(named: "editImage"),  style: .normal))
            } else if i == 2 {
                alert.addAction(AlertAction(title: "Delete", rightImage: UIImage(named: "editImage"),  style: .destructive))
            } else {
                alert.addAction(AlertAction(title: "Button \(i)", rightImage: UIImage(named: "editImage"),  style: .normal))
            }
        }
